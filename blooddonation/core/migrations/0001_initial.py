    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('security_question', models.CharField(blank=True, choices=[('pet_name', 'What is your pet’s name?'), ('birth_city', 'In what city were you born?'), ('first_school', 'What is the name of your first school?')], max_length=50)),
